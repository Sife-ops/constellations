...
export type _Dev1Query = {
  ...
  _dev1?: Array<{
    ...
    categories?: Array<{ __typename?: 'Category'; id?: number | null; name?: string | null } | null> | null;
  } | null> | null;
};
...
export type _Dev3Query = {
  __typename?: 'Query';
  _dev3?: { __typename?: 'User'; id?: number | null; email?: string | null; username?: string | null } | null;
};
...
export type BookmarkAddMutation = {
  __typename?: 'Mutation';
  bookmarkAdd?: {
    __typename?: 'Bookmark';
    id?: number | null;
...
export type CategoryAddMutation = {
  __typename?: 'Mutation';
  categoryAdd?: { __typename?: 'Category'; id?: number | null; name?: string | null } | null;
};
...
export type CategoryDeleteMutation = {
  __typename?: 'Mutation';
  categoryDelete?: { __typename?: 'Category'; id?: number | null; name?: string | null } | null;
};
...
export type CategoryUpdateMutation = {
  __typename?: 'Mutation';
  categoryUpdate?: { __typename?: 'Category'; id?: number | null; name?: string | null } | null;
};
...
export type LoginMutation = {
  __typename?: 'Mutation';
  login?: { __typename?: 'User'; id?: number | null; email?: string | null; username?: string | null } | null;
};
...
export type RegisterMutation = {
  __typename?: 'Mutation';
  register?: { __typename?: 'User'; email?: string | null; username?: string | null } | null;
};
...
export const _Dev0Component = (
  props: Omit<Urql.QueryProps<_Dev0Query, _Dev0QueryVariables>, 'query'> & { variables?: _Dev0QueryVariables }
...
export const _Dev1Component = (
  props: Omit<Urql.QueryProps<_Dev1Query, _Dev1QueryVariables>, 'query'> & { variables?: _Dev1QueryVariables }
...
export const _Dev2Component = (
  props: Omit<Urql.QueryProps<_Dev2Query, _Dev2QueryVariables>, 'query'> & { variables?: _Dev2QueryVariables }
...
export const _Dev3Component = (
  props: Omit<Urql.QueryProps<_Dev3Query, _Dev3QueryVariables>, 'query'> & { variables?: _Dev3QueryVariables }
...
export const BookmarkAddComponent = (
  props: Omit<Urql.MutationProps<BookmarkAddMutation, BookmarkAddMutationVariables>, 'query'> & {
    variables?: BookmarkAddMutationVariables;
  }
...
export const BookmarkDeleteComponent = (
  props: Omit<Urql.MutationProps<BookmarkDeleteMutation, BookmarkDeleteMutationVariables>, 'query'> & {
    variables?: BookmarkDeleteMutationVariables;
  }
...
export const BookmarkUpdateComponent = (
  props: Omit<Urql.MutationProps<BookmarkUpdateMutation, BookmarkUpdateMutationVariables>, 'query'> & {
    variables?: BookmarkUpdateMutationVariables;
  }
...
export const BookmarksComponent = (
  props: Omit<Urql.QueryProps<BookmarksQuery, BookmarksQueryVariables>, 'query'> & {
...
export const CategoriesComponent = (
  props: Omit<Urql.QueryProps<CategoriesQuery, CategoriesQueryVariables>, 'query'> & {
...
export const CategoryAddComponent = (
  props: Omit<Urql.MutationProps<CategoryAddMutation, CategoryAddMutationVariables>, 'query'> & {
    variables?: CategoryAddMutationVariables;
  }
...
export const CategoryDeleteComponent = (
  props: Omit<Urql.MutationProps<CategoryDeleteMutation, CategoryDeleteMutationVariables>, 'query'> & {
...
export const CategoryUpdateComponent = (
  props: Omit<Urql.MutationProps<CategoryUpdateMutation, CategoryUpdateMutationVariables>, 'query'> & {
...
export const RegisterComponent = (
  props: Omit<Urql.MutationProps<RegisterMutation, RegisterMutationVariables>, 'query'> & {
...
export const UserExistsComponent = (
  props: Omit<Urql.MutationProps<UserExistsMutation, UserExistsMutationVariables>, 'query'> & {
    variables?: UserExistsMutationVariables;
  }
...
export const UserComponent = (
  props: Omit<Urql.QueryProps<UserQuery, UserQueryVariables>, 'query'> & { variables?: UserQueryVariables }
